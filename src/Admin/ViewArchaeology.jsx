...
export const ViewArchaeology = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://worshipbackend.onrender.com/admin/viewnewarchprofile/');
        ...
        <tbody>
          {currentItems.map((item, index) => (
            <tr key={index} className="bg-white border-b text-black">
              ...
              <td className="px-6 py-4"><div className='w-28 h-20'><img src={`https://worshipbackend.onrender.com/uploads/${item?.photo}`} alt="" /></div></td>
